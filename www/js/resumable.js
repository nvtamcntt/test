...
"use strict";
  ...
  var Resumable = function(opts){
    ...
    var appendfunction = function(e){
        appendFilesFromFileList(e.target.files,e);
    }

    $.RemoveUpload = function(input_ele){
      input_ele.removeEventListener('change', appendfunction ,false);
    }
    $.StartUpload = function(input_ele){
      input_ele.addEventListener('change', appendfunction ,false);
    };
