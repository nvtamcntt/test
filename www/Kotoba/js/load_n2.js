module.controller('LoadN2Controller', ['$scope', '$filter', '$http', '$sce','$window', '$compile', '$timeout','$rootScope','$q', 'SharedScopes', function($scope, $filter, $http, $sce,$window, compile,$timeout,$rootScope,$q, SharedScopes) {
