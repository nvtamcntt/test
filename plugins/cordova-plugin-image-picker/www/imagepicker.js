...
ImagePicker.prototype.getPictures = function(success, fail, options) {
	...
	var params = {
		maximumImagesCount: options.maximumImagesCount ? options.maximumImagesCount : 3,
		width: options.width ? options.width : 1980,
		height: options.height ? options.height : 1980,
